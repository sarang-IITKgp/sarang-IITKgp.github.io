...
The projects that I am offering lie on the above research spectrum. However, individual projects are generally not spread throughout the spectrum. <span style="color:blue">The **predominant scope** of each project is a subset of the spectrum and is **indicated by a green bar for each project**.</span> Ordering of the projects below is arbitrary. 
